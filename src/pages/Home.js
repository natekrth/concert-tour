...
const Home = () => {
  return (
    <div className='max-w-[1400px] h-[300px] m-auto'>
      <Slide></Slide>
      <div className='mx-24'>
        ...
        <div className='w-full grid grid-cols-3 gap-2 m-5 max-[980px]:grid-cols-1 max-xl:grid-cols-2'>
        ...
        <div className='w-full grid grid-cols-5 gap-5 m-5 max-xl:grid-cols-2'>
          <Artistbox></Artistbox>
          <Artistbox></Artistbox>
          <Artistbox></Artistbox>
          <Artistbox></Artistbox>
